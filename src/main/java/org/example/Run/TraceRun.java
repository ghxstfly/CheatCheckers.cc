...
public class TraceRun {
    ...
    public void start() {
        String tempDir = System.getenv("TEMP") + "\\cheatchecker\\JournalTrace";
        String exePath = tempDir + "\\JournalTrace.exe";

        try {
            extractFileFromJar("JournalTrace/JournalTrace.exe", exePath);
